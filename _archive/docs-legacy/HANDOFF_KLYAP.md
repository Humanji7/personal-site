...
**v13.8 — Typing Indicator Bugfix** ✅ ГОТОВО
...
|--------|------|-----------|
| **v13.8** | 2026-01-12 | Bugfix: typing indicator не очищался перед отображением LLM ответа — `roomResponse.classList.remove('typing')` перемещён из finally в `showRoomResponse()` |
| v13.7 | 2026-01-12 | Text-Driven refinement: +8 text segments (22 total, ~3 depth spacing), word-spacing 0.5em + letter-spacing 0.25em, TEXT_APPEAR_DELAY 0.5s (was 2s), MIN_DISPLAY_TIME 1800ms (was 2500ms) |
